...
ActiveRecord::Schema.define(:version => 201506300727272) do

  create_table "app_sync_infos", :force => true do |t|
    t.string   "name"
    t.datetime "last_sync"
    t.boolean  "in_prgress", :default => false
  ...
  create_table "inia_member_nanba_roles", :force => true do |t|
  ...
  create_table "inia_member_roles", :force => true do |t|
    t.integer   "member_id",      :default => 0, :null => false
    t.integer   "role_id",        :default => 0, :null => false
    t.integer   "inherited_from"
    t.datetime  "created_at",                    :null => false
  ...
  create_table "inia_members", :force => true do |t|
  ...
  create_table "roles", :force => true do |t|
    ...
    t.text    "permissions"
    t.string  "issues_visibility", :limit => 30, :default => "default", :null => false
    t.boolean "ticketing_role",                  :default => false
  end
