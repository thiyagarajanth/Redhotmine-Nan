...
class Journal < ActiveRecord::Base
  ...
  def send_notification
    p "========#{self.journalized_id}================== send notification ====start======1======="
    Rails.logger.info "========#{self.journalized_id}================== send notification ====start======1======="
    if notify? && (Setting.notified_events.include?('issue_updated') ||
      ...
      p "========#{self.journalized_id}================== send notification ====end======1======="
      Rails.logger.info "========#{self.journalized_id}================== send notification ====end======1======="
    end
  end
end
