...
class Mailer < ActionMailer::Base
  ...
  def issue_edit(journal, to_users, cc_users)
    p "===============issue_edit=======#{journal.journalized_id}============start===========3======"
    Rails.logger.info "========#{journal.journalized_id}=================issue_edit====start===========3=========="
    ...
    mail :to => to_users.map(&:mail),
      :cc => cc_users.map(&:mail),
      :subject => s
    p "===============issue_edit=======#{journal.journalized_id}============end======3==========="
    Rails.logger.info "========#{journal.journalized_id}===================issue_edit=====end======3======="
  end

  # Notifies users about an issue update
  def self.deliver_issue_edit(journal)
    p "===============deliver_issue_edit=======#{journal.journalized_id}=============start===2============="
    Rails.logger.info "========#{journal.journalized_id}==================deliver_issue_edit=====start======2======="
    ...
    p "===============deliver_issue_edit=======#{journal.journalized_id}==========end========2==========="
    Rails.logger.info "========#{journal.journalized_id}================== deliver_issue_edit=====end======2======="
  end
